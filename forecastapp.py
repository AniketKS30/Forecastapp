...
if page == "Application":
    ...
    try:
        if sample:
            st.markdown("""[download_link](https://www.kaggle.com/code/konradb/ts-3-time-series-for-finance/data?select=TATAMOTORS.csv)""")    
    ...
    with st.container():
        ...
        with st.expander('Holidays'):
            ...
            countries = ['Country name','Australia','France','Germony','India','Italy','United Kingdom','United States']
            ...
            with st.container():
                ...
                if selected_country == 'Australia':
                    for date, name in sorted(holidays.AU(years=years).items()):
                        st.write(date,name)
